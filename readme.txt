...
* Navigationaware assistance using depth and segmentation
 ...
 GitHub shields/badges (stars, forks, license)
 Autogenerated requirements.txt
 Screenshot or diagram of the pipeline

Ill help you build a perfect presentation.
